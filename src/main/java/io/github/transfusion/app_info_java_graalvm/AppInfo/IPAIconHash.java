...
public abstract class IPAIconHash extends AbstractPolyglotAdapter {
    public String name() {
    ...
    public String uncrushed_file() {
        Value accessor = getContext().eval("ruby", "-> hash, key { hash[key] }");
        return accessor.execute(getValue(), getContext().eval("ruby", ":uncrushed_file")).asString();
    }
