...
public class MobileProvisionTest {
    ...
    @Test
    void macOSDevelopment() {
        Context ctx = createContext();
        String resourceName = "mobileprovisions/macos_development.provisionprofile";
        String absolutePath = getResourcesAbsolutePath(resourceName);

        MobileProvision subject = MobileProvision.from(ctx, absolutePath);
        Assertions.assertEquals(subject.devices().length, 1);

        Assertions.assertEquals(subject.platform(), "macos");
        Assertions.assertArrayEquals(subject.platforms(), new String[]{"macos"});
        ...
        Assertions.assertNotNull(subject.profile_name());
        Assertions.assertTrue(subject.created_date().isEqual(ZonedDateTime.parse("2020-07-21T16:44:02+08:00")));
        Assertions.assertTrue(subject.expired_date().isEqual(ZonedDateTime.parse("2021-07-21T16:44:02+08:00")));
    ...
    void macOSAppStore() {
        Context ctx = createContext();
        String resourceName = "mobileprovisions/macos_appstore.provisionprofile";
        String absolutePath = getResourcesAbsolutePath(resourceName);
        ...
        Assertions.assertNotNull(subject.profile_name());
        Assertions.assertTrue(subject.created_date().isEqual(ZonedDateTime.parse("2020-07-21T16:46:19+08:00")));
        Assertions.assertTrue(subject.expired_date().isEqual(ZonedDateTime.parse("2020-10-24T16:40:28+08:00")));
