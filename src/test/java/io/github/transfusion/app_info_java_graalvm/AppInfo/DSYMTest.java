...
//        it { expect(subject.macho_type).to be_a ::MachO::MachOFile }
        ...
        Assertions.assertEquals(subject.machos_().size(), 1);

        Assertions.assertEquals(subject.machos_().get(0).type(), "dsym");
        Assertions.assertEquals(subject.machos_().get(0).uuid(), "ea9bbf2d-bfdd-3ce0-85b2-1cbe7152fca5");
        Assertions.assertEquals(subject.machos_().get(0).cpu_type(), "arm64");
        Assertions.assertEquals(subject.machos_().get(0).cpu_name(), "arm64");
        Assertions.assertEquals(subject.machos_().get(0).size(), 866911);
        Assertions.assertEquals(subject.machos_().get(0).humanSize(), "846.59 KB");
...
//        it { expect(subject.macho_type).to be_a ::MachO::MachOFile }
        ...
        Assertions.assertEquals(subject.machos_().size(), 2);

        Assertions.assertEquals(subject.machos_().get(0).type(), "dsym");
        Assertions.assertEquals(subject.machos_().get(0).uuid(), "26dfc15d-bdce-351f-b5de-6ee9f5dd6d85");
        Assertions.assertEquals(subject.machos_().get(0).cpu_type(), "arm");
        Assertions.assertEquals(subject.machos_().get(0).cpu_name(), "armv7");
        Assertions.assertEquals(subject.machos_().get(0).size(), 866526);
        Assertions.assertEquals(subject.machos_().get(0).humanSize(), "846.22 KB");

        // it { expect(subject.machos[0].to_h).to eq data[0] }

        Assertions.assertEquals(subject.machos_().get(1).type(), "dsym");
        Assertions.assertEquals(subject.machos_().get(1).uuid(), "17f58291-dd25-3fc8-9417-ccbe8163d33e");
        Assertions.assertEquals(subject.machos_().get(1).cpu_type(), "arm64");
        Assertions.assertEquals(subject.machos_().get(1).cpu_name(), "arm64");
        Assertions.assertEquals(subject.machos_().get(1).size(), 866911);
        Assertions.assertEquals(subject.machos_().get(1).humanSize(), "846.59 KB");
